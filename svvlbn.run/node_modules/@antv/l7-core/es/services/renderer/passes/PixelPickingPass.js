...
var PixelPickingPass = (_dec = injectable(), _dec2 = inject(TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_BaseNormalPass) {
  ...
  _createClass(PixelPickingPass, [{
    ...
    value: function init(layer, config) {
      ...
      this.interactionService.on(InteractionEvent.Select, this.selectFeatureHander.bind(this));
      this.interactionService.on(InteractionEvent.Active, this.highlightFeatureHander.bind(this));
    }
  }, {
    key: "render",
