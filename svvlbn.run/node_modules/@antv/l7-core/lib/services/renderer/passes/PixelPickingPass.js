...
var PixelPickingPass = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_BaseNormalPass) {
  ...
  (0, _createClass2.default)(PixelPickingPass, [{
    ...
    value: function init(layer, config) {
      ...
      this.interactionService.on(_IInteractionService.InteractionEvent.Select, this.selectFeatureHander.bind(this));
      this.interactionService.on(_IInteractionService.InteractionEvent.Active, this.highlightFeatureHander.bind(this));
    }
  }, {
    key: "render",
    ...
    key: "selectFeatureHander",
    value: function selectFeatureHander(_ref2) {
    ...
    key: "highlightFeatureHander",
    value: function highlightFeatureHander(_ref3) {
