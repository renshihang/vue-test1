...
export declare function generateLightingUniforms(lights?: Array<Partial<IDirectionalLight | ISpotLight>>): {
    u_DirectionalLights: Pick<IDirectionalLight, "ambient" | "diffuse" | "specular" | "direction">[];
    u_NumOfDirectionalLights: number;
    u_SpotLights: Pick<ISpotLight, "linear" | "blur" | "ambient" | "diffuse" | "specular" | "direction" | "position" | "constant" | "quadratic" | "angle" | "exponent">[];
