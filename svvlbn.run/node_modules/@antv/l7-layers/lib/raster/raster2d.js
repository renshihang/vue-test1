...
var Raster2dLayer = function (_BaseLayer) {
  (0, _inherits2.default)(Raster2dLayer, _BaseLayer);
  ...
  function Raster2dLayer() {
    ...
    (0, _classCallCheck2.default)(this, Raster2dLayer);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Raster2dLayer)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(Raster2dLayer, [{
    key: "buildModels",
