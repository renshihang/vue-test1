...
var RasterLayer = function (_BaseLayer) {
  (0, _inherits2.default)(RasterLayer, _BaseLayer);
  ...
  function RasterLayer() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(RasterLayer)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(RasterLayer, [{
      ...
      this.models.forEach(function (model) {
        return model.draw({
          uniforms: {
            ...
            u_extent: [].concat((0, _toConsumableArray2.default)(coordinates[0]), (0, _toConsumableArray2.default)(coordinates[1]))
          }
        });
      });
      return this;
    ...
    value: function buildRasterModel() {
      ...
      var triangulation = (0, _triangulation.RasterTriangulation)(sourceFeature);
