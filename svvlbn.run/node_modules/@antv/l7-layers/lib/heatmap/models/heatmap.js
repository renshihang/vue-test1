...
var HeatMapModel = function (_BaseModel) {
  ...
  function HeatMapModel() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(HeatMapModel)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(HeatMapModel, [{
      ...
      return this.layer.buildLayerModel({
        ...
        blend: {
          ...
          func: {
            ...
            srcAlpha: _l7Core.gl.ONE_MINUS_SRC_ALPHA,
            dstRGB: _l7Core.gl.ONE,
            dstAlpha: _l7Core.gl.ONE_MINUS_SRC_ALPHA
          }
        }
      });
    }
    ...
    value: function draw3DHeatMap() {
      ...
      var invert = _glMatrix.mat4.invert(_glMatrix.mat4.create(), _glMatrix.mat4.fromValues.apply(_glMatrix.mat4, (0, _toConsumableArray2.default)(this.cameraService.getViewProjectionMatrix())));
    ...
    value: function build3dHeatMap() {
      ...
      var triangulation = (0, _triangulation2.heatMap3DTriangulation)(width / 2.0, height / 2.0);
