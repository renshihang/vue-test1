...
var _ConfigSchemaValidationPlugin = _interopRequireDefault(require("./plugins/ConfigSchemaValidationPlugin"));
...
_l7Core.container.bind(_l7Core.TYPES.ILayerPlugin).to(_ConfigSchemaValidationPlugin.default).inRequestScope();
