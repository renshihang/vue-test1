...
function direction(out, a, b) {
  var a1 = (0, _l7Utils.aProjectFlat)([a[0], a[1]]);
  var b1 = (0, _l7Utils.aProjectFlat)([b[0], b[1]]);

  _glMatrix.vec2.sub(out, a1, b1);
...
function lineSegmentDistance(end, start) {
  var a1 = (0, _l7Utils.aProjectFlat)([start[0], start[1]]);
  var b1 = (0, _l7Utils.aProjectFlat)([end[0], end[1]]);
  var dx = a1[0] - b1[0];
  var dy = a1[1] - b1[1];
